...
namespace DetectPeople.YOLOv5.DataStructures
{
    public class Prediction
    {
        ...
        public IReadOnlyList<ObjectDetectResult> GetResults(string[] categories, float scoreThres = 0.5f, float iouThres = 0.5f)
        {
        ...
        private List<ObjectDetectResult> ApplyNMS(List<float[]> postProcessedResults, string[] categories, float iouThres = 0.5f)
        {
